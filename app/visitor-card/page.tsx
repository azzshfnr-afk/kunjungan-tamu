...
export default function VisitorCardPage() {
  ...
  const filteredTab = data.filter((item) => {
    ...
    if (tab === "upcoming") return new Date(item.visitDate) > new Date();
    return true;
  });
              ...
              <div className="flex justify-between mb-4">
                ...
                <div className="flex gap-2">
                  <Sheet>
                    ...
                    <SheetContent>
                      <SheetHeader>
                        <SheetTitle>Detail Tamu</SheetTitle>
                        <SheetDescription>
                          Informasi lengkap
                        </SheetDescription>
                      </SheetHeader>
                      ...
                      <div className="mt-6 space-y-3 text-sm">
                        ...
                        <Detail
                          ...
                          value={formatDateTime(card.visitDate)}
                        />
                        <Detail
                          label="Check-in"
                          value={formatDateTime(card.checkin)}
                        />
                      </div>
